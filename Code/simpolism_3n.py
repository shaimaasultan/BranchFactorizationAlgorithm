...
def getPrimeFactorsChain(A, l=[]):
    ...
    for i in [2,3,5,7]:
        r = (A/i)
        if A%i == 0 : 
            lg.info('Factor {} = {} * {:.25g} = {}, Scientific notation ={}'.format(A ,i , r , A,repr(r)))
            if r not in l:
                l.append(r)
    i = 7
    breakat = breakAt(A)
    while i <= breakat > 0:
        ...
        r = (A/(i+2))
        if (A%int(i+2) == 0 ):
            lg.info('Factor {} = {} * {:.25g} = {} , Scientific notation ={}'.format(A ,i+2, r  , A , repr(r)))
            if r not in l : 
                l.append(r)
            l = getPrimeFactorsChain(r , l)
        i = i + 2
...
def getFirstPrimeFactor(A):
    ...
    while i <= breakat  > 0:
        i = i + 4
        if (A%int(i) == 0 ):
            lg.info('Factor {} = {} * {:.25g} = {}'.format(A ,i, (A/i)  , A))
            return i
        if (A%int(i+2) == 0 ):
            lg.info('Factor {} = {} * {:.25g} = {}'.format(A ,i+2, (A/(i+2))  , A))
            return i
        i = i + 2
        #if i <= 100 * math.sqrt(A) : break
    return i
...
def sixfact(N):
    i =1 
    x = N/6
    lg.info('factor of 6 {} after {} division'.format(x,i))
    while str(int(x)) != str(x):
        i = i + 1
        x = x / 6
        lg.info('factor of 6 {} after {} division'.format(x,i))
        if x <= 0 : break
...
A = 7777777777779777777777777
A = 7777777777779111111111111
A = 7777777777779333333333333
A = 7777777777779333333333337
A = 7777777777779333333333339
A = 1386642349674234678427311
A = 138664234967423467842731971
A = 8723745725348723462437924329
A= 414141414144141414141414141
A=  123456789123
#A = 7777779777777
#A = 2147375693
#A = 1234567891234
...
lg.info('factor of 6 : break after {} divide'.format(sixfact(A)))
...
lg.info('{}'.format(len('25925925925932592592592592592')))
End_T = time.time()
